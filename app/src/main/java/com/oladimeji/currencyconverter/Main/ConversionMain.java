...
public class ConversionMain extends AppCompatActivity {
    ...
    private List<HashMap<String, Double>> listOfCurrencies = Currency.getCurrencies();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(selectedCard.equals("BITCOIN")) {
            ...
            digitalCurrencyIcon.setImageResource(R.drawable.bitcoinicon); // Set bitcoin logo
        } else {
            ...
            digitalCurrencyIcon.setImageResource(R.drawable.ethereumicon);// Set Ethereum logo
        }
